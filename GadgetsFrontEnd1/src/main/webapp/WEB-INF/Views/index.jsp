...
<c:url value="/resources/webfonts" var="webfonts"/>
			...
			<div class="row main-top-w3l py-2">
				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					...
					<ul>
						...
						<li class="text-center text-white">
							<a href="<c:url value="/j_spring_security_logout"/>" class="text-white">
				...
				<c:url value="/j_spring_security_check" var="login"/>
					<form action="${login}" method="post">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder=" " name="j_username" required="">
						</div>
						<div class="form-group">
							<label class="col-form-label">Password</label>
							<input type="password" class="form-control" placeholder=" " name="j_password" required="">
						</div>
						<div class="right-w3l">
				...
				<c:url value="/adduser" var="use"/>
					<form:form action="${use}" method="post" commandName="user">
						<div class="form-group">
							...
							<form:input type="text" class="form-control" placeholder=" " name="Name" path="UserId" required=""/>
							
						</div>
						<div class="form-group">
							<label class="col-form-label">Name</label>
							<form:input type="text" class="form-control" placeholder=" " name="Name" path="UserName" required=""/>
						</div>
						<div class="form-group">
							<label class="col-form-label">Email-ID</label>
							<form:input type="email" class="form-control" path="UserEmailId" placeholder=" " name="EMailID"  required=""/>
						</div>
						<div class="form-group">
							<label class="col-form-label">Phno</label>
							<form:input type="tel" class="form-control" path="UserPhno" placeholder=" " name="Phno" required=""/>
						</div>
						
						<div class="form-group">
							<label class="col-form-label">Address</label>
							<form:input type="text" class="form-control" path="UserAddress" placeholder=" " required=""/>
						</div>
						<div class="form-group">
							<label class="col-form-label">Password</label>
							<form:input type="password" class="form-control" path="UserPassword" placeholder=" " name="Phno" required=""/>
						</div>
						<div class="right-w3l">
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.html" class="font-weight-bold font-italic">
							<img src="${img}/logo2.png" alt=" " class="img-fluid">Electro Store
						</a>
					</h1>
				</div>
				<!-- //logo -->
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="${img}/${pro.getProductId()}.jpg" alt="">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.html">${pro.getProductName()}</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">${pro.getProductPrice()}</span>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<c:url value="/addtocart/${pro.getProductId()}" var="cart"/>
												<form action="${cart}" method="post">
													<fieldset>
														
														<input type="hidden" name="business" value=" " />
														<input type="hidden" name="item_name" value="${pro.getProductName()}"/>
														<input type="hidden" name="amount" value="${pro.getProductPrice()}" />
